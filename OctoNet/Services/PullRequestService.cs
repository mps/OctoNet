...
namespace OctoNet.Services
{
    public class PullRequestService : IPullRequestService
    {
        ...
        #region IPullRequestService Members
                                                             ...
                                                             Action<GitHubException> onError)
        {
            ...
            string resource = string.Format("/repos/{0}/{1}/pulls", user, repo);
                                                                 ...
                                                                 Action<GitHubException> onError)
        {
            ...
            string resource = string.Format("/repos/{0}/{1}/pulls/{2}/merge",
                                            user,
                                            repo,
                                            pullRequestId);
            var request = new GitHubRequest(resource, API.v3, Method.GET);
                                                        ...
                                                        Action<GitHubException> onError)
        {
            ...
            string resource = string.Format("/repos/{0}/{1}/pulls/{2}/commits",
                                            user,
                                            repo,
                                            pullRequestId);
                                                      ...
                                                      Action<GitHubException> onError)
        {
            ...
            string resource = string.Format("/repos/{0}/{1}/pulls/{2}/files",
                                            user,
                                            repo,
                                            pullRequestId);
            var request = new GitHubRequest(resource, API.v3, Method.GET, Parameter.Page(page));
                                                        ...
                                                        Action<GitHubException> onError)
        {
            ...
            string resource = string.Format("/repos/{0}/{1}/pulls/comments/{2}",
                                            user,
                                            repo,
                                            commentId);
            var request = new GitHubRequest(resource, API.v3, Method.GET);
